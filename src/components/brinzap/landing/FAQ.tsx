...
const faqs = [
  { q: "Preciso baixar algum app?", a: "Não. O Shark Money funciona dentro do WhatsApp. O painel web é só o complemento visual, e abre direto no navegador." },
  ...
  { q: "E se a IA errar alguma coisa?", a: "É só responder na conversa: “na verdade foi 80” ou “foi ontem”. O Shark Money corrige o lançamento anterior automaticamente." },
