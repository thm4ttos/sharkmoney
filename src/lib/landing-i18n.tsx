...
const DICT = {
  pt: {
    ...
    "hero.title2": "O Shark Money resolve.",
    "hero.sub":
    ...
    "steps.2.desc": "Você receberá uma mensagem do Shark Money automaticamente. É só responder e começar.",
    "steps.3.title": "Pronto!",
    "steps.3.desc": "Envie textos, áudios, fotos ou PDFs. O Shark Money organiza o resto.",
    "examples.title1": "Basta conversar.",
    "examples.title2": "O Shark Money entende.",
    ...
    "gift.desc": "Teste todos os recursos do Shark Money sem compromisso.",
  ...
  en: {
    ...
    "hero.title2": "Shark Money handles it.",
    "hero.sub":
    ...
    "steps.2.desc": "You'll get a message from Shark Money automatically. Just reply and go.",
    "steps.3.title": "Done!",
    "steps.3.desc": "Send text, audio, photos or PDFs. Shark Money organizes the rest.",
    "examples.title1": "Just chat.",
    "examples.title2": "Shark Money understands.",
    ...
    "gift.desc": "Try every Shark Money feature with no commitment.",
    "gift.close": "Dismiss",
